...
import { hexToBytes } from "../dist/ckb/index.js";
...
const GOLDEN_CKB =
  "";
const GOLDEN_XUDT =
  "";

function sample(variant) {
  return {
    variant,
    assetTypeHash: variant === VARIANT_XUDT ? "0x" + "ab".repeat(32) : undefined,
    shareXudtCodeHash: "0x" + "cd".repeat(32),
    treasuryLockCodeHash: variant === VARIANT_XUDT ? "0x" + "ef".repeat(32) : undefined,
